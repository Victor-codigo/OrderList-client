...
class listOrdersCreateController extends AbstractController
{
    ...
    public function __invoke(RequestDto $requestDto): Response
    {
        ...
        if ($listOrdersCreateForm->isSubmitted() && $listOrdersCreateForm->isValid()) {
            $this->createListOrders($listOrdersCreateForm, $requestDto->groupData->id, $requestDto->tokenSession);
        }
        ...
        return $this->controllerUrlRefererRedirect->createRedirectToRoute(
            ...
            $this->listOrdersCreateComponent->loadErrorsTranslation($listOrdersCreateForm->getErrors()),
            []
        );
    }
