...
class OrderModifyComponentLangDto
{
    ...
    public readonly string $orderModifyButton;
    ...
    public function buttons(string $orderModifyButton, string $closeButton): self
    {
        $this->builder->setMethodStatus('buttons', true);

        $this->orderModifyButton = $orderModifyButton;
