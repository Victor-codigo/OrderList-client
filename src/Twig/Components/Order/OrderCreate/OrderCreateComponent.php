    ...
    public function loadErrorsTranslation(array $errors): array
    {
        ...
        foreach ($errors as $field => $error) {
            $errorsLang[] = match ($field) {
                ORDER_CREATE_FORM_ERRORS::GROUP_ID ,
                ORDER_CREATE_FORM_ERRORS::ORDERS_EMPTY ,
                ORDER_CREATE_FORM_ERRORS::PRODUCT_NOT_FOUND,
                ORDER_CREATE_FORM_ERRORS::GROUP_ERROR => $this->translate('validation.error.internal_server'),
