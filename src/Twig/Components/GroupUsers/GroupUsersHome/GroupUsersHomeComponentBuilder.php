...
namespace App\Twig\Components\GroupUsers\GroupUsersHome;
...
use App\Twig\Components\GroupUsers\GroupUsersAdd\GroupUsersAddComponentDto;
use App\Twig\Components\GroupUsers\GroupUsersHome\Home\GroupUsersHomeSectionComponentDto;
use App\Twig\Components\GroupUsers\GroupUsersHome\ListItem\GroupUsersListItemComponent;
use App\Twig\Components\GroupUsers\GroupUsersHome\ListItem\GroupUsersListItemComponentDto;
use App\Twig\Components\GroupUsers\GroupUsersInfo\GroupUserInfoComponent;
use App\Twig\Components\GroupUsers\GroupUsersInfo\GroupUserInfoComponentDto;
use App\Twig\Components\GroupUsers\GroupUsersRemove\GroupUsersRemoveComponent;
use App\Twig\Components\GroupUsers\GroupUsersRemove\GroupUsersRemoveComponentDto;
...
class GroupUsersHomeComponentBuilder implements DtoBuilderInterface
{
    ...
    public function groupUserAddFormModal(string $groupId, string $groupUsersCreateFormCsrfToken, string $groupUsersCreateFormActionUrl): self
    {
        ...
        $this->homeSectionComponentDto->createFormModal(
            $this->createGroupUsersAddComponentDto($groupId, $groupUsersCreateFormCsrfToken, $groupUsersCreateFormActionUrl)
        );
    ...
    private function createGroupUsersAddComponentDto(string $groupId, string $groupUserAddFormCsrfToken, string $groupUserAddFormActionUrl): ModalComponentDto
    {
        $homeSectionCreateComponentDto = new GroupUsersAddComponentDto(
            [],
            '',
            $groupId,
            '',
        ...
        return new ModalComponentDto(
            ...
            '',
            false,
            GroupUsersAddComponent::getComponentName(),
