...
class GroupUserAddForm extends FormType
{
    private const FORM_CSRF_TOKEN_ID = 'groupUserAddCsrfTokenId';

    public static function getName(): string
    {
        return GROUP_USER_ADD_FORM_FIELDS::FORM;
    }
    ...
    {
        return GROUP_USER_ADD_FORM_FIELDS::TOKEN;
    }
    ...
    {
        $this
            ->addField(GROUP_USER_ADD_FORM_FIELDS::GROUP_ID, FIELD_TYPE::HIDDEN)
            ->addField(GROUP_USER_ADD_FORM_FIELDS::NAME, FIELD_TYPE::TEXT)
            ->addField(GROUP_USER_ADD_FORM_FIELDS::TOKEN, FIELD_TYPE::HIDDEN)
            ->addField(GROUP_USER_ADD_FORM_FIELDS::SUBMIT, FIELD_TYPE::SUBMIT);
    }
}
