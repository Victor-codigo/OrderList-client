...
class ProductCreateForm extends FormType
{
    ...
    public function formBuild(): void
    {
        $this
            ...
            ->addField(PRODUCT_CREATE_FORM_FIELDS::SHOP_ID, FIELD_TYPE::COLLECTION)
            ->addField(PRODUCT_CREATE_FORM_FIELDS::SHOP_NAME, FIELD_TYPE::COLLECTION)
            ->addField(PRODUCT_CREATE_FORM_FIELDS::SHOP_PRICE, FIELD_TYPE::COLLECTION)
            ->addField(PRODUCT_CREATE_FORM_FIELDS::SHOP_UNIT_MEASURE, FIELD_TYPE::COLLECTION);
    }
}
